...
class User(Base):
    ...
    languages_spoken: Mapped[list[str]] = mapped_column(JSON, default=list, server_default="[]")
    political_views: Mapped[str | None] = mapped_column(String(50), default=None)
    beliefs: Mapped[str | None] = mapped_column(String(50), default=None)
    hidden_fields: Mapped[list[str]] = mapped_column(JSON, default=list, server_default="[]")
